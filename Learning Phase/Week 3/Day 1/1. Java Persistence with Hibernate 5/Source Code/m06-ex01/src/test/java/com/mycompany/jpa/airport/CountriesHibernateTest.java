...
import com.mycompany.jpa.airport.Country;
...
public class CountriesHibernateTest {
	...
	public static final String[][] COUNTRY_INIT_DATA = { { "Australia", "AU" }, { "Canada", "CA" }, { "France", "FR" },
			...
			{ "Russian Federation", "RU" }, { "Spain", "ES" }, { "Switzerland", "CH" }, { "United Kingdom", "UK" },
			{ "United States", "US" } };
	...
	public void setUp() {
		...
		emf = Persistence.createEntityManagerFactory("hibernatejpa.m06.ex01");
